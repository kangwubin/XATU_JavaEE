...
import com.projects.core.common.constant.cache.Cache;
import com.projects.core.common.constant.cache.CacheKey;
import com.projects.core.common.constant.state.ManagerStatus;
import com.projects.core.common.constant.state.MenuStatus;
...
import com.projects.modular.system.entity.Dict;
import com.projects.modular.system.entity.DictType;
...
public class ConstantFactory implements IConstantFactory {
    ...
    private RegisterUserMapper registerUserMapper = SpringContextHolder.getBean(RegisterUserMapper.class);
    ...
    @Override
    public String getRegUserAccountById(Long userId) {
        RegisterUser user = registerUserMapper.selectById(userId);
        if (user != null) {
            return user.getName();
        } else {
            return "--";
